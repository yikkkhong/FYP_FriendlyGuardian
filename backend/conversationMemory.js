...
const CONVERSATION_FILE_PATH = path.join(
  __dirname,
...
class ConversationMemory {
  ...
  readConversations() {
    try {
      ...
      console.error(
        '🔥 Error reading conversation memory:',
        error
      );
  ...
  writeConversations(conversations) {
    try {
      ...
      console.error(
        '🔥 Error writing conversation memory:',
        error
      );
    }
  }
  ...
  createConversation(title = 'New Conversation', topic = 'general') {
    ...
    console.log(
      `💬 [Conversation] Created: ${conversation.id} - ${title}`
    );
  ...
  switchConversation(conversationId) {
    ...
    console.log(
      `🔄 [Conversation] Switched to: ${conversationId}`
    );
